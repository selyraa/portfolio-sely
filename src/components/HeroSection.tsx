      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
        ...
        >
          ...
          <div>
            ...
            <a href="/SelyRuliAmanda_CurriculumVitae.pdf" download className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-primary to-cyan-400 hover:bg-slate-800 text-white mt-3">
